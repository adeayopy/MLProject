...
class Learner(nn.Module):
    # Defining the learner/classifier model which has 4 convolutional layers.
    # each layers is a 3 × 3 convolution with 32 filters,followed by batch normalization, 
    # a ReLU activation, and lastly a 2 × 2 max-pooling.
    def __init__(self, image_size, bn_eps, bn_momentum, n_classes):
        ...
        #calcaulate final image output size
    ...
    # Compute the forward pass of the NN given input tensor x
    def forward(self, x):
    ...
    # The resulting flattened parameter tensor can be used as input 
    # to an optimization algorithm, such as stochastic gradient descent, 
